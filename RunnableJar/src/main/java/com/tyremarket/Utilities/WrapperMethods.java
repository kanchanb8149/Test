...
public class WrapperMethods {
	...
	public WebElement findElementPresentByXpath(String xpath,WebDriver driver,String Element_Name) throws InterruptedException
	{
		try
		{
			driver.findElement(By.xpath(xpath));
	...
	public WebElement key_down_with_inputTxt(String xpath,WebDriver driver,String Element_Name,String sValue) throws InterruptedException
	{
		try
		{
	...
	public void inputText_Enter_By_cssSelector(WebDriver screenName, String ObjectxPath, String sValue,String Element_Name) throws Exception {
		try
		{
			WebElement inputText = screenName.findElement(By.cssSelector(ObjectxPath));
	...
	public void sendkeys_enter(WebDriver screenName, String ObjectxPath, String Element_Name) throws Exception {
		try
		{
			WebElement inputText = screenName.findElement(By.xpath(ObjectxPath));
			inputText.sendKeys(Keys.ENTER);
			//Extent_Reporting.Log_Pass(Element_Name+" Entered" + " entered in "+ Element_Name);
		}  catch(Throwable t)
		{ 
			Extent_Reporting.Log_Fail(Element_Name+" does not Exist",Element_Name+" does not Exist", screenName);
			t.printStackTrace();
...
public void javascriptExecutor_Scroll(WebDriver driver,String XpathObject,String ObjectName)
{
	try {
	  WebElement e=driver.findElement(By.xpath(XpathObject));
       JavascriptExecutor js = ((JavascriptExecutor) driver);
